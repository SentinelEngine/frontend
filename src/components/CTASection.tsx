  ...
  return (
    <section className="cta-section" ref={ref}>
      ...
      <motion.div
        ...
        style={{ willChange: 'transform, opacity' }}
      >
        <a href="" target="_blank" rel="noopener noreferrer" className="btn-t cta-btn-anim" onClick={handleConfetti}>
          Install for VS Code — Free
        </a>
        <a href="" target="_blank" rel="noopener noreferrer" className="btn-g cta-btn-anim">
